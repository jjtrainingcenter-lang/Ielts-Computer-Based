...
export const TestAudioLinkManager: React.FC<TestAudioLinkManagerProps> = ({
  tests,
  onRefresh,
  onStatus,
}) => {
  ...
  const saveAudioLink = async () => {
    ...
    try {
      ...
      // Store one full-test recording. The candidate player already uses the
      // single available audio source across Listening Parts 1–4.
