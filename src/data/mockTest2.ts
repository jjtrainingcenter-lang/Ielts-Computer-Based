    ...
    paragraphs: [
      {
        ...
        alt: 'Official IELTS Upgrade Academic Practice Test 2 Reading Passage 1 - Daydreaming',
      },
    ],
  },
  {
    ...
    paragraphs: [
      {
        ...
        alt: 'Official IELTS Upgrade Academic Practice Test 2 Reading Passage 2 - Tricky Sums and Psychology',
      },
    ],
  },
  {
    ...
    paragraphs: [
      {
        ...
        alt: 'Official IELTS Upgrade Academic Practice Test 2 Reading Passage 3 - Care in the Community',
      },
    ],
  },
];
...
const WRITING_TASKS: WritingTaskData[] = [
  {
    ...
    prompt:
      'The graph below shows relative rates of language acquisition according to different study methods. Summarise the information by selecting and reporting the main features and make comparisons where relevant.',
    minWordCount: 150,
    timeLimitMinutes: 20,
    imageUrl: '/assets/mock-tests/test2-writing-task1.jpg',
    imageAlt: 'Official Practice Test 2 Writing Task 1 graph - Speed of Language Learning',
    imageZoomable: true,
  },
  {
    taskNumber: 2,
    ...
    prompt:
      'Parents are often over-anxious to teach their children to speak. If children are ‘slow-developers’ parents will often allow psychologists and schools to intervene and give their children speech therapy. Do you think children develop at different rates and so should be left to themselves to acquire language skills, or, is such intervention justified? Discuss both views and give your own opinion.',
    minWordCount: 250,
    timeLimitMinutes: 40,
  },
];
...
const SPEAKING_TASKS: SpeakingTaskData[] = [
  ...
  },
  {
    ...
    topic: 'Describe a particularly memorable language lesson that you had.',
    cueCard: {
      mainTopic: 'Describe a particularly memorable language lesson that you had.',
      bulletPoints: [
        'why it was so memorable',
        'who gave the lesson',
        'how the lesson helped you improve or focus on an aspect of language',
      ],
    },
    questions: [],
    prepTimeSeconds: 60,
...
export const ACADEMIC_TEST_2: IELTSTest = {
  ...
  description:
    'IELTS Upgrade Academic Practice Test 2 reconstructed from the supplied official PDF and official answer key. Original PDF pages are used for Listening and Reading so the layout and wording remain faithful to the source. Listening audio is intentionally blank for Admin attachment.',
  listeningData: [
    {
      partNumber: 1,
      title: 'Listening Test - Practice Test 2',
      audioUrl: '',
      audioDuration: 0,
      instructions: 'Attach the complete Practice Test 2 Listening recording in Admin.',
    },
  ],
  listeningQuestions: buildOfficialQuestions(2, 'listening', LISTENING_ANSWERS, [
    {
      ...
      groupId: 't2-listening-1',
      instruction: 'SECTION 1 — Questions 1–10',
      imageUrl: '/assets/mock-tests/test2-listening-part1.jpg',
      partNumber: 1,
    ...
    },
    {
      ...
      groupId: 't2-listening-2',
      instruction: 'SECTION 2 — Questions 11–20',
      imageUrl: '/assets/mock-tests/test2-listening-part2.jpg',
      partNumber: 2,
    ...
    },
    {
      ...
      groupId: 't2-listening-3',
      instruction: 'SECTION 3 — Questions 21–30',
      imageUrl: '/assets/mock-tests/test2-listening-part3.jpg',
      partNumber: 3,
      questionType: 'multiple-choice-single-answer',
      optionValues: ['A', 'B', 'C'],
    },
    ...
    },
    {
      ...
      groupId: 't2-listening-4',
      instruction: 'SECTION 4 — Questions 31–40',
      imageUrl: '/assets/mock-tests/test2-listening-part4.jpg',
      partNumber: 4,
      questionType: 'fill-blank',
    },
  ]),
  ...
  readingQuestions: buildOfficialQuestions(2, 'reading', READING_ANSWERS, [
    {
      ...
      groupId: 't2-reading-1',
      instruction: 'Questions 1–13 — answer using the official question page below.',
      imageUrl: '/assets/mock-tests/test2-reading-questions1.jpg',
      passageId: 't2-p1',
      partNumber: 1,
      questionType: 'true-false-not-given',
      optionValues: ['TRUE', 'FALSE', 'NOT GIVEN'],
    },
    {
      start: 9,
      end: 10,
    ...
    },
    {
      ...
      groupId: 't2-reading-2',
      instruction: 'Questions 14–25 — answer using the official question page below.',
      imageUrl: '/assets/mock-tests/test2-reading-questions2.jpg',
      passageId: 't2-p2',
      partNumber: 2,
    ...
    },
    {
      ...
      groupId: 't2-reading-3',
      instruction: 'Questions 26–40 — answer using the official question page below.',
      imageUrl: '/assets/mock-tests/test2-reading-questions3.jpg',
      passageId: 't2-p3',
      partNumber: 3,
      questionType: 'multiple-choice-single-answer',
      optionValues: ['A', 'B', 'C', 'D'],
